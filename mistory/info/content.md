...
Storyteller makes it a little easier to manage this process, by removing the need for you to directly deal with HTML and CSS files. The text files you create are plain text, not HTML, and they include a few special "tags" that identify features such as headers, hyperlinks or pictures. These special tags are very easy to learn and after a while become second nature to most people. The system is called **_Markdown_**; a Google search will turn up plenty of information about it. Storyteller adds a few special tags of its own; these are documented here on our ~sid:Markdown~ page.

Storyteller is easy to use and anyone can build their own website with it. Most of the work is in writing the copy and finding the photos that will illustrate that copy. You can host yours for free on [Neocities](https://neocities.org), where setting up an account is very simple.

If you have questions, feel free to write to [the author of the Storyteller system](mailto:gtanyware@gmail.com). If you are intending to try it out you are welcome to get in touch.

Storyteller is at [https://easycoder.github.io/storyteller](https://easycoder.github.io/storyteller)
